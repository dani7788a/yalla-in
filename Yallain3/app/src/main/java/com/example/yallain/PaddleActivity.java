    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PaddleActivity.this, ProfileActivity.class);
                intent.putExtra("USER", loggedInEmail);
                startActivity(intent);
            }
        });
        homeButton.setOnClickListener(v -> {
            Intent intent = new Intent(PaddleActivity.this, MainActivity.class);
            startActivity(intent);
            finish();
        });
        ...
        findViewById(R.id.rent1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String loggedInEmail = getLoggedInUser();
                rentStadium("Paddle", "Paddle Club Court", loggedInEmail);
            }
        });
        findViewById(R.id.rent2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String loggedInEmail = getLoggedInUser();
                rentStadium("Paddle", "The Padelist Court", loggedInEmail);
            }
        });
    }
    ...
    public void showTimePickerDialog(View v) {
        TimePickerDialog.OnTimeSetListener startTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                TimePickerDialog endTimePickerDialog = new TimePickerDialog(PaddleActivity.this, endTimeSetListener, 0, 0, true);
